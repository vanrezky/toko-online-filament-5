...
- `bristol-shop-footer-reference.png`: all-products, newsletter, trust strip, and footer composition.

They are kept as design references only. They are not production assets and should not be rendered directly in the storefront.
