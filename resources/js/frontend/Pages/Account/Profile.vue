...
import { Package, MapPin, Settings, ChevronRight, X, Plus, Trash2, Edit3, Heart, Clock, Wallet } from "lucide-vue-next";
                ...
                <AccountShell :user="user" :balance-enabled="balanceEnabled" :active-destination="activeSection">
                    ...
                    <div v-if="activeSection === 'overview'" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 items-stretch gap-4 sm:grid-cols-2">
                            <div
                                v-if="balanceEnabled"
                                class="border-border bg-background flex h-full flex-col rounded-2xl border p-5 shadow-sm transition-shadow hover:shadow-md"
                            >
                            ...
                            >
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <div v-if="featuredAddress" class="space-y-2">
                                            <div class="flex items-center gap-2">
                                                <h4 class="text-foreground truncate font-bold">{{ featuredAddress.name }}</h4>
                                                <span class="bg-primary/10 text-primary shrink-0 rounded-full px-2 py-0.5 text-[10px] font-bold">{{
                                                    t("labels.address.default_badge")
                                                }}</span>
                                            </div>
                                            <p class="text-muted-foreground line-clamp-2 text-sm">
                                                {{ featuredAddress.address }}, {{ featuredAddress.village_name }},
                                                {{ featuredAddress.sub_district_name }}
                                            </p>
                                        </div>
                                ...
                                <div class="border-border/60 mt-auto flex items-center justify-between border-t pt-3">
                                    ...
                                    <Button
                                        ...
                                        ><Edit3 class="h-3 w-3" />{{ t("labels.actions.manage_addresses") }}</Button
                                    >
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-if="activeSection === 'addresses'" class="space-y-6">
                        ...
                        <div class="grid gap-4">
                            <div
                                ...
                                :key="address.id"
                                class="border-border bg-background rounded-2xl border p-6 shadow-sm transition-shadow hover:shadow-md"
                                ...
                                <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                    ...
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <template v-if="canManageAddress(address)">
                                            <Button v-if="!address.is_featured" variant="outline" size="sm" @click="setFeaturedAddress(address)">
                        ...
                        <form class="border-border bg-background space-y-5 rounded-2xl border p-6 shadow-sm" @submit.prevent="submitAddress">
                            <div class="grid gap-4 md:grid-cols-2">
                                <label class="text-foreground space-y-2 text-sm font-semibold">
                                    ...
                                    <span v-if="addressForm.errors.name" class="text-destructive text-xs font-medium">{{
                                ...
                                <label class="text-foreground space-y-2 text-sm font-semibold">
                                    ...
                                    <span v-if="addressForm.errors.phone" class="text-destructive text-xs font-medium">{{
                            ...
                            <label class="text-foreground block space-y-2 text-sm font-semibold">
                                ...
                                />
                                <span v-if="addressForm.errors.address" class="text-destructive text-xs font-medium">{{
                            ...
                            <div class="grid gap-4 md:grid-cols-2">
                                ...
                                <label class="text-foreground space-y-2 text-sm font-semibold">
                                    ...
                                    <span v-if="addressForm.errors.district_id" class="text-destructive text-xs font-medium">{{
                                ...
                                <label class="text-foreground space-y-2 text-sm font-semibold">
                                    ...
                                    <span v-if="addressForm.errors.sub_district_id" class="text-destructive text-xs font-medium">{{
                                ...
                                <label class="text-foreground space-y-2 text-sm font-semibold">
                                    ...
                                    <span v-if="addressForm.errors.village_id" class="text-destructive text-xs font-medium">{{
                                        addressForm.errors.village_id
                                    }}</span>
                                </label>
                            </div>
                            ...
                            <label class="text-foreground block space-y-2 text-sm font-semibold">
                                ...
                                <span v-if="addressForm.errors.postal_code" class="text-destructive text-xs font-medium">{{
