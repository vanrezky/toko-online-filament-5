...
Record the active execution correlation ID on audit activity metadata so a given user action can be traced back through the audit trail to its originating request, job, or console run.
