...
class DashboardStats
{
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('revenue'), $this->cacheSeconds, function () {
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('orders'), $this->cacheSeconds, function () {
            $stats = $this->getCombinedStats();
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('customers'), $this->cacheSeconds, function () {
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('aov'), $this->cacheSeconds, function () {
            $stats = $this->getCombinedStats();
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('trend'), $this->cacheSeconds, function () {
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey("top_{$limit}"), $this->cacheSeconds, function () use ($limit) {
    ...
    {
        return CacheService::rememberManaged('dashboard', $this->getCacheKey('lowstockcount'), $this->cacheSeconds, function () {
            return Product::where('is_active', true)
                ->whereColumn('stock', '<=', 'security_stock')
                ->count();
        });
