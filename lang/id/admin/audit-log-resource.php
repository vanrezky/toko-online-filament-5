...
return [
    ...
    'filters' => ['actor' => 'Aktor', 'action' => 'Aksi', 'subject_type' => 'Tipe Subjek', 'from' => 'Dari tanggal', 'until' => 'Sampai tanggal'],
    'sections' => ['activity' => 'Aktivitas', 'metadata' => 'Metadata Request', 'changes' => 'Perubahan'],
    'entries' => ['actor' => 'Aktor', 'action' => 'Aksi', 'subject' => 'Subjek', 'timestamp' => 'Waktu', 'description' => 'Deskripsi', 'ip' => 'IP', 'method' => 'Method', 'url' => 'URL', 'user_agent' => 'User Agent', 'field' => 'Field', 'old' => 'Nilai Lama', 'new' => 'Nilai Baru'],
