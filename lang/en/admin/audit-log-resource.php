...
return [
    ...
    'filters' => ['actor' => 'Actor', 'action' => 'Action', 'subject_type' => 'Subject Type', 'from' => 'From date', 'until' => 'Until date', 'correlation_id' => 'Correlation ID'],
    'sections' => ['activity' => 'Activity', 'metadata' => 'Request Metadata', 'changes' => 'Changes'],
    'entries' => ['actor' => 'Actor', 'action' => 'Action', 'subject' => 'Subject', 'timestamp' => 'Timestamp', 'description' => 'Description', 'correlation_id' => 'Correlation ID', 'ip' => 'IP', 'method' => 'Method', 'url' => 'URL', 'user_agent' => 'User Agent', 'field' => 'Field', 'old' => 'Old Value', 'new' => 'New Value'],
